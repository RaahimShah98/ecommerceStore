...
console.log('chartData:', this.chartData);
      ...
      const ctx1 = this.$refs.barChartCanvas.getContext('2d');
          ...
          datasets: [
            {
              ...
              backgroundColor: 'rgba(72 , 150 , 120 , 0.8)',
              data: this.chartData,
            },
          ],
        },
  ...
  mounted() {
    axios.get("http://localhost:8080/manageOrder/viewCustomerByArea").then(response=>{
